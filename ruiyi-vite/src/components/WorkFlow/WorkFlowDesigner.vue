 ...
 * @Date: 2022-10-05 17:56:43
 * @LastEditors: sdf iamsdf@163.com
 * @LastEditTime: 2022-10-06 04:43:29
 * @FilePath: \ryvue3\src\components\HelloWorld.vue
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
-->
<template>
  <div style="height:90vh;">
    <div id="bpmncanvas" style="height:90vh;width: 100%;"></div>
    <!-- //此处简单使用scrollbar，此处为右侧属性栏的html代码 -->
    <el-scrollbar height="90vh"
      style="width:300px; position:absolute;top:0px;right:0px;background-color: #f8f8f8; border: 1px solid #ccc;">
      <div id="js-properties-panel" class="panel"></div>
    </el-scrollbar>
    <!-- //此处我放置了几个按钮，导出和部署，导出的ref绑定也是必要的 -->
    <ul class="buttons">
      <li class="item download">
        <el-button class="btn" @click="exportBPMN" ref="exportbtn">导出</el-button>
      </li>
      <li class="item submit">
        <el-button class="btn" @click="deploy" ref="deploybtn">部署</el-button>
      </li>
    </ul>
  </div>
</template>
...
<script  setup>
import { onMounted, markRaw, ref, defineProps } from 'vue'
// // 左侧工具栏的样式 
...
const props = defineProps({
  ...
  wfInfo: {
    ...
    default: () => {
      return {
        proc_id: "process112233",
        proc_name: '流程12345',
        proc_documentation: '描述',
      }
    }
  },
  wfmode: {
...
<?xml version="1.0" encoding="UTF-8"?>
        <bpmn2:definitions xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" id="sample-diagram" targetNamespace="http://bpmn.io/schema/bpmn" xsi:schemaLocation="http://www.omg.org/spec/BPMN/20100524/MODEL BPMN20.xsd">
          <bpmn2:process id="process_${Date.now()}" name="新的审批">
            <bpmn2:documentation>备注</bpmn2:documentation>
...
<?xml version="1.0" encoding="UTF-8"?>
        <bpmn2:definitions xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" id="sample-diagram" targetNamespace="http://bpmn.io/schema/bpmn" xsi:schemaLocation="http://www.omg.org/spec/BPMN/20100524/MODEL BPMN20.xsd">
          <bpmn2:process id="process_${Date.now()}" name="新的流程">
            <bpmn2:documentation>备注</bpmn2:documentation>
            <bpmn2:startEvent id="StartEvent_1" name="开始"/>
          </bpmn2:process>
          <bpmndi:BPMNDiagram id="BPMNDiagram_1">
...
async function init() {  // 加markRaw去除双向绑定作用域
  ...
  try {
    ...
    //// 将图形dom挂载到目标节点
    let parentNode = document.getElementById("bpmncanvas")
    modeler.attachTo(parentNode);
