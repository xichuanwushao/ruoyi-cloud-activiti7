...
INSERT INTO `config_info` VALUES (2, 'ruoyi-gateway-dev.yml', 'DEFAULT_GROUP', 'spring:\n  redis:\n    host: 82.157.888.888\n    port: 6379\n    password: your_password\n    database: 14 \n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: ruoyi-auth\n          uri: lb://ruoyi-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n            # 验证码处理\n            - CacheRequestFilter\n            - ValidateCodeFilter\n            - StripPrefix=1\n        # 代码生成\n        - id: ruoyi-gen\n          uri: lb://ruoyi-gen\n          predicates:\n            - Path=/code/**\n          filters:\n            - StripPrefix=1\n        # 定时任务\n        - id: ruoyi-job\n          uri: lb://ruoyi-job\n          predicates:\n            - Path=/schedule/**\n          filters:\n            - StripPrefix=1\n        # 系统模块\n        - id: ruoyi-system\n          uri: lb://ruoyi-system\n          predicates:\n            - Path=/system/**\n          filters:\n            - StripPrefix=1\n        # 文件服务\n        - id: ruoyi-file\n          uri: lb://ruoyi-file\n          predicates:\n            - Path=/file/**\n          filters:\n            - StripPrefix=1\n        # activiti7模块\n        - id: ruoyi-danny\n          uri: lb://ruoyi-danny\n          predicates:\n            - Path=/danny/**\n          filters:\n            - StripPrefix=1\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n      - /system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - /auth/logout\n      - /auth/login\n      - /auth/register\n      - /*/v2/api-docs\n      - /csrf\n', '3b7fa9fea3e06ff89e598af2a78f195d', '2020-05-14 14:17:55', '2022-09-17 06:45:58', 'nacos', '45.11.104.180', '', '36a6cffb-6ec5-4ed8-a357-f4170e2ab131', '网关模块', 'null', 'null', 'yaml', 'null');
...
INSERT INTO `config_info` VALUES (10, 'ruoyi-danny-dev.yml', 'DEFAULT_GROUP', 'demonstrate:\n  open: false\nfile:\n  path: /opt/service-storehouse/upload\nbpmn:\n  path: domain: http://152.136.153.155:9204\nmanage:\n  roleId: 10\nmybatis-plus:\n  mapper-locations: classpath:./mapper_xml/*.xml\nplugin:\n  pluginConfigFilePath: pluginConfig\n  pluginPath: plugins\n  runMode: prod\ntenant:\n  tryDayLimit: 3000\n  userNumLimit: 1000000\n\n# spring配置\nspring:\n  activiti:\n    database-schema-update: true\n    historyLevel: audit\n    db-history-used: true\n  redis:\n    host: 82.157.888.888\n    port: 6379\n    password: your_password\n    database: 14 \n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: your_password\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://82.157.888.888:3306/ruoyi-cloud-activiti7?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8&nullCatalogMeansCurrent=true\n          username: root\n          password: your_password\n          # 从库数据源\n          # slave:\n          # username:\n          # password:\n          # url:\n          # driver-class-name:\n      # seata: true    # 开启seata代理，开启后默认每个数据源都代理，如果某个不需要代理可单独关闭\n\n# seata配置\nseata:\n  # 默认关闭，如需启用spring.datasource.dynami.seata需要同时开启\n  enabled: false\n  # Seata 应用编号，默认为 ${spring.application.name}\n  application-id: ${spring.application.name}\n  # Seata 事务组编号，用于 TC 集群名\n  tx-service-group: ${spring.application.name}-group\n  # 关闭自动代理\n  enable-auto-data-source-proxy: false\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      huoyan-system-group: default\n  config:\n    type: nacos\n    nacos:\n      serverAddr: 82.157.888.888:8848\n      group: SEATA_GROUP\n      namespace:\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: 82.157.888.888:8848\n      namespace:\n\n  servlet:\n    multipart:\n      max-file-size: 10485760\n      max-request-size: 10485760\n\n# mybatis配置\nmybatis:\n  # 搜索指定包别名\n  typeAliasesPackage: com.ruoyi.danny\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 系统模块接口文档\n  license: Powered By huoyan\n  licenseUrl: https://huoyan.vip\n', 'be036f7d5c568372de365dc88686b517', '2022-09-06 10:07:58', '2022-09-17 06:47:33', 'nacos', '45.11.104.180', '', '36a6cffb-6ec5-4ed8-a357-f4170e2ab131', '', '', '', 'yaml', '');
